...
class otp_verifier(Tk):
    def __init__(self):
        ...
        self.n = str(self.OTP())
        self.client = Client("AC88e55f6410cb446392b97922bb43f8f5", "2a988b1e0f7bbaf257100d114d95b65c")
        self.client.messages.create(to =("+917415457965"),
                      from_ ="+14259529492",
                     body = self.n)
...
### Center textboxes
        ...
        self.picture = PhotoImage (file = "Otp_logo.png")
        ...
        self.simpli_logo = PhotoImage(file = "logo2.png")
        self.d = Label(self, image= self.simpli_logo, fg="white").place(x=10, y= 5 )
        
        self.simpli_logo = PhotoImage(file = "logo.png")
